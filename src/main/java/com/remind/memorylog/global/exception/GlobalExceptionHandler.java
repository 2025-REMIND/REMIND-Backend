...
import com.remind.memorylog.global.response.ErrorResponse;
import com.remind.memorylog.global.response.code.GlobalErrorCode;
...
// 역할 : Spring Boot에서 전역적으로 예외를 처리하기 위한 예외 처리 중심 허브 역할을 함
@RestControllerAdvice // 모든 컨트롤러의 예외를 잡아서 JSON 형태로 응답을 내려줌
@Slf4j // log.error(...)과 같은 로깅 기능을 제공
