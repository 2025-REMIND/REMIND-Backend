...
public enum MissionErrorCode implements BaseResponseCode {
    MISSION_NOT_FOUND_404("MISSION_NOT_FOUND_404", NOT_FOUND,"존재하지 않는 데이트 코스입니다."),
    MISSION_DETAIL_NOT_FOUND_404("MISSION_DETAIL_NOT_FOUND_404", NOT_FOUND,"존재하지 않는 데이트 코스 내역입니다.");
